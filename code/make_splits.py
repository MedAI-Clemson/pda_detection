...
# data paths
frame = '/zfs/wficai/pda/model_data/20220901_frame.csv'
video = '/zfs/wficai/pda/model_data/20220901_video.csv'
study = '/zfs/wficai/pda/model_data/20220901_study.csv'
patient_study = '/zfs/wficai/pda/model_data/20220901_patient_study.csv'
patient = '/zfs/wficai/pda/model_data/20220901_patient.csv'
...
test_frac = 0.25
val_frac = 0.1
val_frac_scaled = val_frac/(1-test_frac)
df_patient_train, df_patient_test = train_test_split(df_patient, test_size=test_frac, shuffle=True)
df_patient_train, df_patient_val = train_test_split(df_patient_train, test_size=val_frac_scaled, shuffle=True)

# merge on frame data
df_train, df_val, df_test = [
    d.merge(df_patient_study).\
